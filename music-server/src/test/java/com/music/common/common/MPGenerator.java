...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/music-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/emberff\">pf</a>");
        ...
        packageConfig.setParent("com.music.common.music");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("658293");
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/musicommunity?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}